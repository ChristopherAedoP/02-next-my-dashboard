					...
					<div className="flex flex-col justify-center items-center">
						...
						<div className="flex flex-wrap gap-1">
							{pokemon.moves.map((move) => (
								...
								<p
									key={move.move.name}
									className="center relative inline-block select-none
										whitespace-nowrap rounded-lg bg-teal-600 py-1 px-1.5
										align-baseline text-xs capitalize leading-none text-white">
									{move.move.name}
								</p>
							))}
						</div>
